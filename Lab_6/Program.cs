...
namespace Lab_6
{
    ...
    class BaseLineFunction : IFunction
    {
        public int aO;
        public int a1;
        public int bO;
        ...
        {
            //провка заданы ли все коэфициенты 
            if (calc == true)
            {
                float F;
                F = ((a1 * xO) + aO) / ((b1 * xO) + bO);
            ...
            // если нет ошибка и вылет програмы 
    ...
    class FractionalFunction : Function
    {
        private int a2;
        private int b2;
        public FractionalFunction(int a0, int A1, int b0, int B1, int A2, int B2):base(a0,A1,b0,B1 , false)
        {
            a2 = A2;
            b2 = B2;
            xO = 0;
        ...
        public override void SetCoefficients(int a0, int A1, int b0, int B1, int A2, int B2)
        {
            aO = a0;
            a1 = A1;
            bO = b0;
